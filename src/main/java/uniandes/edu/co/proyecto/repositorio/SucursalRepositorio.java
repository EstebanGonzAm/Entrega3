...
public interface SucursalRepositorio extends JpaRepository<SucursalEntity, Integer> {
    ...
    @Modifying
    @Transactional
    @Query(value = "INSERT INTO Sucursal(id_sucursal,nombre,tamanio,direccion,telefono) VALUES(proyecto_sequence.nextval, :nombre, :tamanio, :direccion, :telefono)", nativeQuery = true)

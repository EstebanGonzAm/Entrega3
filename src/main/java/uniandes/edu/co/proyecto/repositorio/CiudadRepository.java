...
public interface CiudadRepository extends JpaRepository<CiudadEntity, Integer> {
    ...
    @Modifying
    @Transactional
    @Query(value = "INSERT INTO Ciudad(id_ciudad, codigo,nombre) VALUES(proyecto_sequence.nextval, :codigo, :nombre )", nativeQuery = true)
    void insertarCiudad(@Param("codigo") Integer codigo, @Param("nombre") String nombre);
